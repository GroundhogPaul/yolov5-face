...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            # Compute loss
            if training:
                loss += compute_loss([x.float() for x in train_out], targets, model)[1]  # box, obj, cls, lmark, loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/Pretrained/yolov5n-face.pt', help='model.pt path(s)')
